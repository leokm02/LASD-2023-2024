...
protected:
  ...
  virtual void QuickSort(const unsigned long p, const unsigned long r) noexcept;
  virtual unsigned long Partition(const unsigned long p, const unsigned long r) noexcept;
