...
public:
  ...
  BST(const TraversableContainer<Data>&); // A bst obtained from a MutableContainer
  BST(MappableContainer<Data>&&) noexcept; // A bst obtained from a MappableMutableContainer
